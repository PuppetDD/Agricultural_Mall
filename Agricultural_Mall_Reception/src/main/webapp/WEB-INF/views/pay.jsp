...
<head>
    ...
    <script>
        ...
        //使用支付宝支付
        function aliPay() {
            location.href = '${pageContext.request.contextPath}/reception/pay/goAliPay?orderNumber=' + '${order.orderNumber}';
        }

        //使用微信支付
        function wxPay() {
            var url = '${pageContext.request.contextPath}/reception/wxPay/showPayQRCode';
            // console.log(url)
            $.post(
                '${pageContext.request.contextPath}/reception/wxPay/goWxPay',
        ...
        function payStatus() {
            ...
            $.post(
                '${pageContext.request.contextPath}/reception/wxPay/CheckPayStatus',
                ...
                function (result) {
                    if (result.status == 1) {
                        ...
                        setTimeout(function () {
                            location.replace('${pageContext.request.contextPath}/reception/wxPay/ShowPayStatus?orderNumber=' + orderNumber);
                        }, 1000);
                    }
                }
            );
