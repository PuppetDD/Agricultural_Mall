...
<head>
    ...
    <script>
        ...
        function showOrderDetailInfo(orderNo) {
            location.href = '${pageContext.request.contextPath}/reception/order/showOrderDetailInfo?orderNo=' + orderNo;
        }
        ...
        function cancelThisOrder() {
            $.post(
                '${pageContext.request.contextPath}/reception/order/cancelOrder',
                {"orderId": $('#orderId').val()},
                function (result) {
                    if (result.status == 1) {
        ...
        function removeOrder() {
            $.post(
                '${pageContext.request.contextPath}/reception/order/removeOrder',
        ...
        function confirmReceiveOrder() {
            $.post(
                '${pageContext.request.contextPath}/reception/order/confirmReceiveOrder',
        ...
        function showNotPaid() {
            location.href = '${pageContext.request.contextPath}/reception/order/showNotPaid';
        }

        //显示未发货的订单列表
        function showNotShipped() {
            location.href = '${pageContext.request.contextPath}/reception/order/showNotShipped';
        }

        //显示待收货的订单列表
        function showReceive() {
            location.href = '${pageContext.request.contextPath}/reception/order/showReceive';
        }

        //显示已完成交易的订单列表
        function showFinished() {
            location.href = '${pageContext.request.contextPath}/reception/order/showFinished';
        }

        //显示已取消的订单列表
        function showCancel() {
            location.href = '${pageContext.request.contextPath}/reception/order/showCancel';
        }

        //显示回收站的订单列表
        function showDelete() {
            location.href = '${pageContext.request.contextPath}/reception/order/showDelete';
        }

        //展示商品详情
        function showProductFromOrder(productId) {
            location.href = '${pageContext.request.contextPath}/reception/product/showProductDetail?id=' + productId;
        }
