...
<head>
    ...
    <script>
        ...
        function showProductDetail(id) {
            location.href = '${pageContext.request.contextPath}/reception/product/showProductDetail?id=' + id;
        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-inline hot-search"
                              action="${pageContext.request.contextPath}/reception/product/searchAllProducts"
                              method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" name="productTypeId">
                                    <option value="-1" selected="selected">搜索全部</option>
            ...
            <div class="row">
                <c:forEach items="${pageInfo.list}" var="product">
                    <div class="col-xs-3  hot-item" id="showDetail" onclick="showProductDetail(${product.id})"
                        ...
                        <div class="panel clear-panel" style="width:270px; height:360px">
