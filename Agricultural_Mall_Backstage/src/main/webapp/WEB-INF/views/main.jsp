    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#order-set").click(function () {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/admin/order/getAllOrders");
            });
    ...
    <div class="content-cc">
        ...
        <div class="clear-bottom head">
            <div class="container head-cc">
                <p>A-Mall <span>后台管理系统</span></p>
                <div class="welcome">
                    <div class="left"><span>${sessionScope.get("systemUser").name}</span></div>
                ...
                <div class="col-xs-2 user-wrap">
                    <ul class="list-group">
                        <li class="list-group-item active myLi" name="userSet" id="product-type-set">
                            <i class="glyphicon glyphicon-tags"></i> &nbsp;商品类型管理
                        </li>
                        ...
                        <c:if test="${sessionScope.get('systemUser').role.id <= 3}">
                            <li class="list-group-item myLi" name="OrderSet" id="order-set">
                                <i class="glyphicon glyphicon-book"></i> &nbsp;订单管理
                            </li>
                            <c:if test="${sessionScope.get('systemUser').role.id <= 2}">
                                <li class="list-group-item myLi" name="userInfo" id="user-set">
                                    <i class="glyphicon glyphicon-user"></i> &nbsp;客户管理
                                </li>
                                <c:if test="${sessionScope.get('systemUser').role.id == 1}">
